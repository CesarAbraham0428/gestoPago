...
@Service
@Slf4j
public class CatalogoProductosPersistenceServiceImpl implements CatalogoProductosPersistenceService {

    private ProductoRepository productoRepository;
    private ProductoMapper productoMapper;

    @Autowired
    public CatalogoProductosPersistenceServiceImpl(ProductoRepository productoRepository, ProductoMapper productoMapper) {
